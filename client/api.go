...
import (
	...
	"github.com/HRInnovationLab/stripe-go/v72/account"
	"github.com/HRInnovationLab/stripe-go/v72/accountlink"
	"github.com/HRInnovationLab/stripe-go/v72/applepaydomain"
	"github.com/HRInnovationLab/stripe-go/v72/balance"
	"github.com/HRInnovationLab/stripe-go/v72/balancetransaction"
	"github.com/HRInnovationLab/stripe-go/v72/bankaccount"
	billingportalconfiguration "github.com/HRInnovationLab/stripe-go/v72/billingportal/configuration"
	billingportalsession "github.com/HRInnovationLab/stripe-go/v72/billingportal/session"
	"github.com/HRInnovationLab/stripe-go/v72/capability"
	"github.com/HRInnovationLab/stripe-go/v72/card"
	"github.com/HRInnovationLab/stripe-go/v72/charge"
	checkoutsession "github.com/HRInnovationLab/stripe-go/v72/checkout/session"
	"github.com/HRInnovationLab/stripe-go/v72/countryspec"
	"github.com/HRInnovationLab/stripe-go/v72/coupon"
	"github.com/HRInnovationLab/stripe-go/v72/creditnote"
	"github.com/HRInnovationLab/stripe-go/v72/customer"
	"github.com/HRInnovationLab/stripe-go/v72/customerbalancetransaction"
	"github.com/HRInnovationLab/stripe-go/v72/discount"
	"github.com/HRInnovationLab/stripe-go/v72/dispute"
	"github.com/HRInnovationLab/stripe-go/v72/ephemeralkey"
	"github.com/HRInnovationLab/stripe-go/v72/event"
	"github.com/HRInnovationLab/stripe-go/v72/fee"
	"github.com/HRInnovationLab/stripe-go/v72/feerefund"
	"github.com/HRInnovationLab/stripe-go/v72/file"
	"github.com/HRInnovationLab/stripe-go/v72/filelink"
	"github.com/HRInnovationLab/stripe-go/v72/identity/verificationreport"
	"github.com/HRInnovationLab/stripe-go/v72/identity/verificationsession"
	"github.com/HRInnovationLab/stripe-go/v72/invoice"
	"github.com/HRInnovationLab/stripe-go/v72/invoiceitem"
	"github.com/HRInnovationLab/stripe-go/v72/issuing/authorization"
	issuingcard "github.com/HRInnovationLab/stripe-go/v72/issuing/card"
	"github.com/HRInnovationLab/stripe-go/v72/issuing/cardholder"
	issuingdispute "github.com/HRInnovationLab/stripe-go/v72/issuing/dispute"
	"github.com/HRInnovationLab/stripe-go/v72/issuing/transaction"
	"github.com/HRInnovationLab/stripe-go/v72/loginlink"
	"github.com/HRInnovationLab/stripe-go/v72/mandate"
	"github.com/HRInnovationLab/stripe-go/v72/oauth"
	"github.com/HRInnovationLab/stripe-go/v72/order"
	"github.com/HRInnovationLab/stripe-go/v72/orderreturn"
	"github.com/HRInnovationLab/stripe-go/v72/paymentintent"
	"github.com/HRInnovationLab/stripe-go/v72/paymentmethod"
	"github.com/HRInnovationLab/stripe-go/v72/paymentsource"
	"github.com/HRInnovationLab/stripe-go/v72/payout"
	"github.com/HRInnovationLab/stripe-go/v72/person"
	"github.com/HRInnovationLab/stripe-go/v72/plan"
	"github.com/HRInnovationLab/stripe-go/v72/price"
	"github.com/HRInnovationLab/stripe-go/v72/product"
	"github.com/HRInnovationLab/stripe-go/v72/promotioncode"
	"github.com/HRInnovationLab/stripe-go/v72/radar/earlyfraudwarning"
	"github.com/HRInnovationLab/stripe-go/v72/radar/valuelist"
	"github.com/HRInnovationLab/stripe-go/v72/radar/valuelistitem"
	"github.com/HRInnovationLab/stripe-go/v72/refund"
	"github.com/HRInnovationLab/stripe-go/v72/reporting/reportrun"
	"github.com/HRInnovationLab/stripe-go/v72/reporting/reporttype"
	"github.com/HRInnovationLab/stripe-go/v72/reversal"
	"github.com/HRInnovationLab/stripe-go/v72/review"
	"github.com/HRInnovationLab/stripe-go/v72/setupattempt"
	"github.com/HRInnovationLab/stripe-go/v72/setupintent"
	"github.com/HRInnovationLab/stripe-go/v72/sigma/scheduledqueryrun"
	"github.com/HRInnovationLab/stripe-go/v72/sku"
	"github.com/HRInnovationLab/stripe-go/v72/source"
	"github.com/HRInnovationLab/stripe-go/v72/sourcetransaction"
	"github.com/HRInnovationLab/stripe-go/v72/sub"
	"github.com/HRInnovationLab/stripe-go/v72/subitem"
	"github.com/HRInnovationLab/stripe-go/v72/subschedule"
	"github.com/HRInnovationLab/stripe-go/v72/taxcode"
	"github.com/HRInnovationLab/stripe-go/v72/taxid"
	"github.com/HRInnovationLab/stripe-go/v72/taxrate"
	terminalconnectiontoken "github.com/HRInnovationLab/stripe-go/v72/terminal/connectiontoken"
	terminallocation "github.com/HRInnovationLab/stripe-go/v72/terminal/location"
	terminalreader "github.com/HRInnovationLab/stripe-go/v72/terminal/reader"
	"github.com/HRInnovationLab/stripe-go/v72/token"
	"github.com/HRInnovationLab/stripe-go/v72/topup"
	"github.com/HRInnovationLab/stripe-go/v72/transfer"
	"github.com/HRInnovationLab/stripe-go/v72/usagerecord"
	"github.com/HRInnovationLab/stripe-go/v72/usagerecordsummary"
	"github.com/HRInnovationLab/stripe-go/v72/webhookendpoint"
)
